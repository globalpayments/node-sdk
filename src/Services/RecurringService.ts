...
export class RecurringService {
  public static create<T extends IRecurringEntity>(entity: T, configName: string = 'default') {
  ...
  public static edit<T extends IRecurringEntity>(entity: T, configName: string = 'default') {
    return new RecurringBuilder<T>(TransactionType.Edit, entity).execute(configName);
  }

  public static get<T extends IRecurringEntity>(key: string, configName: string = 'default') {
    const entity = key;
