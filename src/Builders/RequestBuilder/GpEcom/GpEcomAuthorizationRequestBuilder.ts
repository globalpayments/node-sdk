...
export class GpEcomAuthorizationRequestBuilder extends GpEcomRequestBuilder implements IRequestBuilder {
    /***
    ...
    buildRequest(builder: AuthorizationBuilder, config: GpEcomConfig): Request {
      ...
      if (
        ...
        subElement(narrative, "chargedescription").append(cData(builder.dynamicDescriptor.toUpperCase()))
      }
