...
export class PayFacBuilder extends BaseBuilder<Transaction> {
    ...
    public withSecondaryBankAccountData(secondaryBankInformation: BankAccountData) {
        this.secondaryBankInformation = secondaryBankInformation;
        return this;
    }

    public withGrossBillingSettleData(grossBillingInformation: GrossBillingInformation) {
    ...
    public withPrimaryBankAccountOwner(primaryBankAccountOwner: BankAccountOwnershipData) {
        this.primaryBankAccountOwner = primaryBankAccountOwner;
        return this;
    }

    public withSecondaryBankAccountOwner(secondaryBankAccountOwner: BankAccountOwnershipData) {
