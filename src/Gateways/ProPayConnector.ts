...
export class ProPayConnector extends XmlGateway implements IPayFacProvider {
  ...
  public processPayFac(builder: PayFacBuilder): Promise<Transaction> {
    ...
    subElement(xmlTrans, "transType").append(
      cData(this.mapRequestType(builder)),
    );

    this.HydrateAccountDetails(xmlTrans, builder);

    return this.doTransaction(new ElementTree(transaction).write()).then(
      (response) => this.mapResponse(builder, response),
    );
  }
  ...
  private HydrateAccountDetails(xmlTrans: element, builder: PayFacBuilder) {
    ...
    if (
      builder.mailingAddressInformation != null ||
    ...
    if (
      builder.beneficialOwnerData != null ||
    ...
    if (builder.FlashFundsPaymentCardData != null) {
      this.HydrateFlashFundsPaymentCardData(
        xmlTrans,
        builder.FlashFundsPaymentCardData,
      );
    }

    if (builder.documentUploadData != null) {
      this.HydrateDocumentUploadData(
        xmlTrans,
        builder.TransactionType,
        builder.documentUploadData,
      );
    }
  ...
  private HydrateBankAccountOwnershipData(
    xmlTrans: Element,
    builder: PayFacBuilder,
  ) {
    if (
      builder.primaryBankAccountOwner != null ||
  ...
  private HydrateMailAddress(
    ...
    subElement(xmlTrans, "mailAddr").append(
      cData(mailingAddressInformation?.streetAddress1),
    );
    subElement(xmlTrans, "mailApt").append(
      cData(mailingAddressInformation?.streetAddress2),
    );
    subElement(xmlTrans, "mailAddr3").append(
      cData(mailingAddressInformation?.streetAddress3),
    );
    subElement(xmlTrans, "mailCity").append(
      cData(mailingAddressInformation?.city),
    );
    subElement(xmlTrans, "mailCountry").append(
      cData(mailingAddressInformation?.country),
    );
    subElement(xmlTrans, "mailState").append(
      cData(mailingAddressInformation?.state),
    );
    subElement(xmlTrans, "mailZip").append(
      cData(mailingAddressInformation?.postalCode),
    );
  }

  private HydrateBankDetails(xmlTrans: Element, builder: PayFacBuilder) {
    if (builder.creditCardInformation != null) {
      subElement(xmlTrans, "NameOnCard").append(
        cData(builder.creditCardInformation.cardHolderName),
      );
      subElement(xmlTrans, "ccNum").append(
        cData(builder.creditCardInformation.number),
      );
      subElement(xmlTrans, "expDate").append(
        cData(builder.creditCardInformation.getShortExpiry()),
      );
    }

    if (builder.aCHInformation != null) {
      subElement(xmlTrans, "PaymentBankAccountNumber").append(
        cData(builder.aCHInformation.accountNumber),
      );
      subElement(xmlTrans, "PaymentBankRoutingNumber").append(
        cData(builder.aCHInformation.routingNumber),
      );
      subElement(xmlTrans, "PaymentBankAccountType").append(
        cData(builder.aCHInformation.accountType),
      );
    }

    if (builder.bankAccountData != null) {
      subElement(xmlTrans, "AccountCountryCode").append(
        cData(builder.bankAccountData.accountCountryCode),
      );
      subElement(xmlTrans, "accountName").append(
        cData(builder.bankAccountData.accountName),
      );
      subElement(xmlTrans, "AccountNumber").append(
        cData(builder.bankAccountData.accountNumber),
      );
      subElement(xmlTrans, "AccountOwnershipType").append(
        cData(builder.bankAccountData.accountOwnershipType),
      );
      subElement(xmlTrans, "AccountType").append(
        cData(builder.bankAccountData.accountType),
      );
      subElement(xmlTrans, "BankName").append(
        cData(builder.bankAccountData.bankName),
      );
      subElement(xmlTrans, "RoutingNumber").append(
        cData(builder.bankAccountData.routingNumber),
      );
    }

    if (builder.secondaryBankInformation != null) {
      subElement(xmlTrans, "SecondaryAccountCountryCode").append(
        cData(builder.secondaryBankInformation.accountCountryCode),
      );
      subElement(xmlTrans, "SecondaryAccountName").append(
        cData(builder.secondaryBankInformation.accountName),
      );
      subElement(xmlTrans, "SecondaryAccountNumber").append(
        cData(builder.secondaryBankInformation.accountNumber),
      );
      subElement(xmlTrans, "SecondaryAccountOwnershipType").append(
        cData(builder.secondaryBankInformation.accountOwnershipType),
      );
      subElement(xmlTrans, "SecondaryAccountType").append(
        cData(builder.secondaryBankInformation.accountType),
      );
      subElement(xmlTrans, "SecondaryBankName").append(
        cData(builder.secondaryBankInformation.bankName),
      );
      subElement(xmlTrans, "SecondaryRoutingNumber").append(
        cData(builder.secondaryBankInformation.routingNumber),
      );
    }
  }

  private HydrateBusinessData(xmlTrans: Element, businessData: BusinessData) {
    subElement(xmlTrans, "BusinessLegalName").append(
      cData(businessData.businessLegalName),
    );
    subElement(xmlTrans, "DoingBusinessAs").append(
      cData(businessData.doingBusinessAs),
    );
    subElement(xmlTrans, "EIN").append(
      cData(businessData.employerIdentificationNumber),
    );
    subElement(xmlTrans, "MCCCode").append(
      cData(businessData.merchantCategoryCode),
    );
    subElement(xmlTrans, "WebsiteURL").append(cData(businessData.websiteURL));
    subElement(xmlTrans, "BusinessDesc").append(
      cData(businessData.businessDescription),
    );
    subElement(xmlTrans, "MonthlyBankCardVolume").append(
      cData(businessData.monthlyBankCardVolume),
    );
    subElement(xmlTrans, "AverageTicket").append(
      cData(businessData.averageTicket),
    );
    subElement(xmlTrans, "HighestTicket").append(
      cData(businessData.highestTicket),
    );
    subElement(xmlTrans, "BusinessAddress").append(
      cData(businessData.businessAddress?.streetAddress1),
    );
    subElement(xmlTrans, "BusinessAddress2").append(
      cData(businessData.businessAddress.streetAddress2),
    );
    subElement(xmlTrans, "BusinessCity").append(
      cData(businessData.businessAddress.city),
    );
    subElement(xmlTrans, "BusinessCountry").append(
      cData(businessData.businessAddress.country),
    );
    subElement(xmlTrans, "BusinessState").append(
      cData(businessData.businessAddress.state),
    );
    subElement(xmlTrans, "BusinessZip").append(
      cData(businessData.businessAddress.postalCode),
    );
    subElement(xmlTrans, "BusinessType").append(
      cData(businessData.businessType),
    );
  }
  ...
  private HydrateUserPersonalData(
    ...
    subElement(xmlTrans, "mInitial").append(
      cData(userPersonalData.middleInitial),
    );
    ...
    if (userPersonalData.sourceEmail != null)
      subElement(xmlTrans, "sourceEmail").append(
        cData(userPersonalData.sourceEmail),
      );
    subElement(xmlTrans, "dayPhone").append(cData(userPersonalData.dayPhone));
    subElement(xmlTrans, "evenPhone").append(
      cData(userPersonalData.eveningPhone),
    );
    subElement(xmlTrans, "NotificationEmail").append(
      cData(userPersonalData.notificationEmail),
    );
    subElement(xmlTrans, "currencyCode").append(
      cData(userPersonalData.currencyCode),
    );
    subElement(xmlTrans, "tier").append(cData(userPersonalData.tier));
    if (userPersonalData.externalID != null)
      subElement(xmlTrans, "externalId").append(
        cData(userPersonalData.externalID),
      );
    // user address
    if (userPersonalData.userAddress != null)
      subElement(xmlTrans, "addr").append(
        cData(userPersonalData.userAddress.streetAddress1),
      );
    if (userPersonalData.userAddress != null)
      subElement(xmlTrans, "aptNum").append(
        cData(userPersonalData.userAddress.streetAddress2),
      );
    if (userPersonalData.userAddress != null)
      subElement(xmlTrans, "addr3").append(
        cData(userPersonalData.userAddress.streetAddress3),
      );
    if (userPersonalData.userAddress != null)
      subElement(xmlTrans, "city").append(
        cData(userPersonalData.userAddress.city),
      );
    if (userPersonalData.userAddress != null)
      subElement(xmlTrans, "state").append(
        cData(userPersonalData.userAddress.state),
      );
    if (userPersonalData.userAddress != null)
      subElement(xmlTrans, "zip").append(
        cData(userPersonalData.userAddress.postalCode),
      );
    if (userPersonalData.userAddress != null)
      subElement(xmlTrans, "country").append(
        cData(userPersonalData.userAddress.country),
      );

    // mailing address
    if (userPersonalData.mailingAddress != null)
      subElement(xmlTrans, "mailAddr").append(
        cData(userPersonalData.mailingAddress.streetAddress1),
      );
    if (userPersonalData.mailingAddress != null)
      subElement(xmlTrans, "mailApt").append(
        cData(userPersonalData.mailingAddress.streetAddress2),
      );
    if (userPersonalData.mailingAddress != null)
      subElement(xmlTrans, "mailAddr3").append(
        cData(userPersonalData.mailingAddress.streetAddress3),
      );
    if (userPersonalData.mailingAddress != null)
      subElement(xmlTrans, "mailCity").append(
        cData(userPersonalData.mailingAddress.city),
      );
    if (userPersonalData.mailingAddress != null)
      subElement(xmlTrans, "mailCountry").append(
        cData(userPersonalData.mailingAddress.state),
      );
    if (userPersonalData.mailingAddress != null)
      subElement(xmlTrans, "mailState").append(
        cData(userPersonalData.mailingAddress.postalCode),
      );
    if (userPersonalData.mailingAddress != null)
      subElement(xmlTrans, "mailZip").append(
        cData(userPersonalData.mailingAddress.country),
      );

    subElement(xmlTrans, "IpSignup").append(cData(userPersonalData.ipSignup));
    subElement(xmlTrans, "USCitizen").append(
      cData(
        userPersonalData.uSCitizen == true
          ? "true"
    ...
    subElement(xmlTrans, "bOAttestation").append(
      cData(
        userPersonalData.bOAttestation == true
          ? "true"
    ...
    subElement(xmlTrans, "TermsAcceptanceIP").append(
      cData(userPersonalData.termsAcceptanceIP),
    );
    subElement(xmlTrans, "TermsAcceptanceTimeStamp").append(
      cData(userPersonalData.termsAcceptanceTimeStamp),
    );
    subElement(xmlTrans, "TermsVersion").append(
      cData(
        userPersonalData.termsVersion == null
          ? ""
  ...
  private HydrateThreatRiskData(
    ...
    subElement(xmlTrans, "MerchantSourceip").append(
      cData(threatRiskData?.merchantSourceIP),
    );
    subElement(xmlTrans, "ThreatMetrixPolicy").append(
      cData(threatRiskData?.threatMetrixPolicy),
    );
    subElement(xmlTrans, "ThreatMetrixSessionid").append(
      cData(threatRiskData?.threatMetrixSessionID),
    );
  }
  ...
  private HydrateSignificantOwnerData(
    ...
    subElement(xmlTrans, "AuthorizedSignerFirstName").append(
      cData(significantOwnerData?.authorizedSignerFirstName),
    );
    subElement(xmlTrans, "AuthorizedSignerLastName").append(
      cData(significantOwnerData?.authorizedSignerLastName),
    );
    subElement(xmlTrans, "AuthorizedSignerTitle").append(
      cData(significantOwnerData?.authorizedSignerTitle),
    );
    subElement(xmlTrans, "SignificantOwnerFirstName").append(
      cData(significantOwnerData?.significantOwner.firstName),
    );
    subElement(xmlTrans, "SignificantOwnerLastName").append(
      cData(significantOwnerData?.significantOwner.lastName),
    );
    subElement(xmlTrans, "SignificantOwnerSSN").append(
      cData(significantOwnerData?.significantOwner.sSN),
    );
    subElement(xmlTrans, "SignificantOwnerDateOfBirth").append(
      cData(significantOwnerData?.significantOwner.DateOfBirth),
    );
    subElement(xmlTrans, "SignificantOwnerStreetAddress").append(
      cData(
        significantOwnerData?.significantOwner.ownerAddress?.streetAddress1,
      ),
    );
    subElement(xmlTrans, "SignificantOwnerCityName").append(
      cData(significantOwnerData?.significantOwner.ownerAddress.city),
    );
    subElement(xmlTrans, "SignificantOwnerRegionCode").append(
      cData(significantOwnerData?.significantOwner.ownerAddress.state),
    );
    subElement(xmlTrans, "SignificantOwnerPostalCode").append(
      cData(significantOwnerData?.significantOwner.ownerAddress.postalCode),
    );
    subElement(xmlTrans, "SignificantOwnerCountryCode").append(
      cData(significantOwnerData?.significantOwner.ownerAddress.country),
    );
    subElement(xmlTrans, "SignificantOwnerTitle").append(
      cData(significantOwnerData?.significantOwner.title),
    );
    subElement(xmlTrans, "SignificantOwnerPercentage").append(
      cData(significantOwnerData?.significantOwner.percentage),
    );
  }
  ...
  private HydrateAccountPermissions(
    ...
    if (accountPermissions.aCHIn != null)
      subElement(xmlTrans, "ACHIn").append(
        cData(accountPermissions.aCHIn == true ? "Y" : "N"),
      );
    if (accountPermissions.aCHOut != null)
      subElement(xmlTrans, "ACHOut").append(
        cData(accountPermissions.aCHOut == true ? "Y" : "N"),
      );
    if (accountPermissions.cCProcessing != null)
      subElement(xmlTrans, "CCProcessing").append(
        cData(accountPermissions.cCProcessing == true ? "Y" : "N"),
      );
    if (accountPermissions.proPayIn != null)
      subElement(xmlTrans, "ProPayIn").append(
        cData(accountPermissions.proPayIn == true ? "Y" : "N"),
      );
    if (accountPermissions.proPayOut != null)
      subElement(xmlTrans, "ProPayOut").append(
        cData(accountPermissions.proPayOut == true ? "Y" : "N"),
      );

    if (accountPermissions.creditCardMonthLimit != null)
      subElement(xmlTrans, "CreditCardMonthLimit").append(
        cData(accountPermissions.creditCardMonthLimit),
      );
    if (accountPermissions.creditCardTransactionLimit != null)
      subElement(xmlTrans, "CreditCardTransactionLimit").append(
        cData(accountPermissions.creditCardTransactionLimit),
      );
    if (accountPermissions.merchantOverallStatus != null)
      subElement(xmlTrans, "MerchantOverallStatus").append(
        cData(String(accountPermissions.merchantOverallStatus)),
      );
  ...
  private HydrateDeviceData(xmlTrans: Element, deviceData: DeviceData) {
    ...
    if (deviceData.devices.length > 0) {
      deviceData.devices.forEach((deviceObj) => {
        ...
        subElement(device, "Quantity").append(
          cData(deviceObj.quantity == null ? "0" : String(deviceObj.quantity)),
        );
  ...
  private HydrateBeneficialOwnerData(
    ...
    subElement(ownerDetails, "OwnerCount").text =
    ...
    if (Number(beneficialOwnerData?.ownersCount) > 0) {
      ...
      beneficialOwnerData.ownersList.forEach((ownerInfo) => {
        ...
        subElement(newOwner, "Address").text =
  ...
  private HydrateGrossBillingData(
    ...
    subElement(xmlTrans, "GrossSettleAddress").append(
      cData(grossBillingInformation.grossSettleAddress?.streetAddress1),
    );
    subElement(xmlTrans, "GrossSettleCity").append(
      cData(grossBillingInformation.grossSettleAddress.city),
    );
    subElement(xmlTrans, "GrossSettleState").append(
      cData(grossBillingInformation.grossSettleAddress.state),
    );
    subElement(xmlTrans, "GrossSettleZipCode").append(
      cData(grossBillingInformation.grossSettleAddress.postalCode),
    );
    subElement(xmlTrans, "GrossSettleCountry").append(
      cData(grossBillingInformation.grossSettleAddress.country),
    );
    subElement(xmlTrans, "GrossSettleCreditCardNumber").append(
      cData(grossBillingInformation.grossSettleCreditCardData.Number),
    );
    subElement(xmlTrans, "GrossSettleNameOnCard").append(
      cData(grossBillingInformation.grossSettleCreditCardData.CardHolderName),
    );
    subElement(xmlTrans, "GrossSettleCreditCardExpDate").append(
      cData(grossBillingInformation.grossSettleCreditCardData.getShortExpiry()),
    );
    subElement(xmlTrans, "GrossSettleAccountCountryCode").append(
      cData(grossBillingInformation.grossSettleBankData.accountCountryCode),
    );
    subElement(xmlTrans, "GrossSettleAccountHolderName").append(
      cData(grossBillingInformation.grossSettleBankData.accountHolderName),
    );
    subElement(xmlTrans, "GrossSettleAccountNumber").append(
      cData(grossBillingInformation.grossSettleBankData.accountNumber),
    );
    subElement(xmlTrans, "GrossSettleAccountType").append(
      cData(grossBillingInformation.grossSettleBankData.accountType),
    );
    subElement(xmlTrans, "GrossSettleRoutingNumber").append(
      cData(grossBillingInformation.grossSettleBankData.routingNumber),
    );
  }

  private HydrateAccountRenewDetails(
    xmlTrans: Element,
    renewAccountData: RenewAccountData,
  ) {
    const elementMap = {
  ...
  private HydrateFlashFundsPaymentCardData(
    xmlTrans: Element,
    cardData: FlashFundsPaymentCardData,
  ) {
    subElement(xmlTrans, "ccNum").append(cData(cardData.creditCard.number));
    subElement(xmlTrans, "expDate").append(
      cData(cardData.creditCard.getShortExpiry()),
    );
    subElement(xmlTrans, "CVV2").append(cData(cardData.creditCard.cvn));
    subElement(xmlTrans, "cardholderName").append(
      cData(cardData.creditCard.cardHolderName),
    );
    subElement(xmlTrans, "addr").append(
      cData(cardData.cardholderAddress?.streetAddress1),
    );
    subElement(xmlTrans, "city").append(cData(cardData.cardholderAddress.city));
    subElement(xmlTrans, "state").append(
      cData(cardData.cardholderAddress.state),
    );
    subElement(xmlTrans, "zip").append(
      cData(cardData.cardholderAddress.postalCode),
    );
    subElement(xmlTrans, "country").append(
      cData(cardData.cardholderAddress.country),
    );
  }
  ...
  private HydrateDocumentUploadData(
    ...
    docUploadData: DocumentUploadData,
  ) {
    const docNameTag =
      transType == TransactionType.UploadDocumentChargeback
        ? "DocumentName"
        : "documentName";
    const docTypeTag =
      transType == TransactionType.UploadDocumentChargeback
    ...
    if (docUploadData.transactionReference) {
      subElement(xmlTrans, "TransactionReference").append(
        cData(docUploadData.transactionReference),
      );
    } else {
      ("");
    }
    ...
    if (docUploadData.docCategory) {
      subElement(xmlTrans, "DocCategory").append(
        cData(docUploadData.docCategory),
      );
    } else {
      ("");
    }
  ...
  private HydrateSSORequestData(
    ...
    subElement(xmlTrans, "ReferrerUrl").append(
      cData(ssoRequestData.referrerURL),
    );
    subElement(xmlTrans, "IpAddress").append(cData(ssoRequestData.iPAddress));
    subElement(xmlTrans, "IpSubnetMask").append(
      cData(ssoRequestData.iPSubnetMask),
    );
  }

  private HydrateOrderDeviceData(
    xmlTrans: Element,
    orderDeviceData: OrderDevice,
  ) {
    subElement(xmlTrans, "accntNum").append(
      cData(orderDeviceData.accountNum.toString()),
    );
    subElement(xmlTrans, "shipTo").append(cData(orderDeviceData.shipTo));
    subElement(xmlTrans, "shipToContact").append(
      cData(orderDeviceData.shipToContact),
    );
    subElement(xmlTrans, "shipToAddress").append(
      cData(orderDeviceData.shipToAddress),
    );
    subElement(xmlTrans, "shipToAddress2").append(
      cData(orderDeviceData.shipToAddress2),
    );
    subElement(xmlTrans, "shipToCity").append(
      cData(orderDeviceData.shipToCity),
    );
    subElement(xmlTrans, "shipToState").append(
      cData(orderDeviceData.shipToState),
    );
    subElement(xmlTrans, "shipToZip").append(cData(orderDeviceData.shipToZip));
    subElement(xmlTrans, "shipToPhone").append(
      cData(orderDeviceData.shipToPhone),
    );
    subElement(xmlTrans, "cardholderName").append(
      cData(orderDeviceData.cardholderName),
    );
    ...
    subElement(xmlTrans, "billingZip").append(
      cData(orderDeviceData.billingZip),
    );
  }
  ...
  private populateProPayResponse(
    ...
    if (
      builder.transactionType == TransactionType.GetAccountDetails &&
      ...
      responseData.visaCheckoutMerchantID = root.findtext(
        ".//visaCheckoutMerchantId",
      );
      responseData.creditCardTransactionLimit = root.findtext(
        ".//CreditCardTransactionLimit",
      );
      responseData.creditCardMonthLimit = root.findtext(
        ".//CreditCardMonthLimit",
      );
      responseData.aCHPaymentPerTranLimit = root.findtext(
        ".//ACHPaymentPerTranLimit",
      );
      responseData.aCHPaymentMonthLimit = root.findtext(
        ".//ACHPaymentMonthLimit",
      );
      responseData.creditCardMonthlyVolume = root.findtext(
        ".//CreditCardMonthlyVolume",
      );
      responseData.aCHPaymentMonthlyVolume = root.findtext(
        ".//ACHPaymentMonthlyVolume",
      );
      responseData.reserveBalance = root.findtext(".//ReserveBalance");
      responseData.masterPassCheckoutMerchantID = root.findtext(
  ...
  private populateResponseWithEnhancedAccountDetails(
    ...
    accountLimits.creditCardTransactionLimit = root.findtext(
      ".//creditCardTransactionLimit",
    );
    accountLimits.creditCardMonthLimit = root.findtext(
      ".//creditCardMonthLimit",
    );
    accountLimits.aCHPaymentSoftLimitEnabled =
      root.findtext(".//achPaymentSoftLimitEnabled")?.toUpperCase() == "Y"
        ? true
        : false;
    accountLimits.aCHPaymentACHOffPercent = root.findtext(
      ".//achPaymentAchOffPercent",
    );
    accountLimits.softLimitEnabled =
      root.findtext(".//softLimitEnabled")?.toUpperCase() == "Y" ? true : false;
    accountLimits.softLimitACHOffPercent = root.findtext(
      ".//softLimitAchOffPercent",
    );

    responseResult.aCHPaymentPerTranLimit = root.findtext(
      ".//achPaymentPerTranLimit",
    );
    responseResult.aCHPaymentMonthLimit = root.findtext(
      ".//achPaymentMonthLimit",
    );
    responseResult.aCHPaymentMonthlyVolume = root.findtext(
      ".//achPaymentMonthlyVolume",
    );
    responseResult.creditCardMonthlyVolume = root.findtext(
      ".//creditCardMonthlyVolume",
    );
    ...
    primaryBankAccountData.accountCountryCode = root.findtext(
      ".//primaryAccountCountryCode",
    );
    primaryBankAccountData.accountType = root.findtext(".//primaryAccountType");
    primaryBankAccountData.accountOwnershipType = root.findtext(
      ".//primaryAccountOwnershipType",
    );
    primaryBankAccountData.bankName = root.findtext(".//primaryBankName");
    primaryBankAccountData.accountNumber = root.findtext(
      ".//primaryAccountNumberLast4",
    );
    primaryBankAccountData.routingNumber = root.findtext(
    ...
    secondaryBankAccountData.accountCountryCode = root.findtext(
      ".//secondaryAccountCountryCode",
    );
    secondaryBankAccountData.accountType = root.findtext(
      ".//secondaryAccountType",
    );
    secondaryBankAccountData.accountOwnershipType = root.findtext(
      ".//secondaryAccountOwnershipTy;e",
    );
    secondaryBankAccountData.bankName = root.findtext(".//secondaryBankName");
    secondaryBankAccountData.accountNumber = root.findtext(
      ".//secondaryAccoun;tNumberLast4",
    );
    secondaryBankAccountData.routingNumber = root.findtext(
    ...
    grossSettleBankData.accountHolderName = root.findtext(
      ".//grossSettleAccountHolderName",
    );
    grossSettleBankData.accountNumber = root.findtext(
      ".//grossSettleAccountNumberLast4",
    );
    grossSettleBankData.routingNumber = root.findtext(
      ".//grossSettleRoutingNumber",
    );
    grossSettleBankData.accountType = root.findtext(
      ".//grossSettleAccountType",
    );

    const grossSettleAddress = new Address();
    grossSettleAddress.streetAddress1 = root.findtext(
      ".//grossSettleAccountAddress",
    );
    ...
    grossSettleAddress.country = root.findtext(
      ".//grossSettleAccountCountryCode",
    );
    grossSettleAddress.postalCode = root.findtext(
      ".//grossSettleAccountZipCode",
    );
  ...
  private getBeneficialOwnerDataResultsFromResponse(
    root: Element,
  ): Array<BeneficialOwnerDataResult> {
