...
import { PayPlanConnector, PorticoConnector, ProPayConnector } from "../../../src/Gateways/";
...
export class PorticoConfig extends GatewayConfig {
    ...
    public configureContainer(services: ConfiguredServices) {
        ...
        if (!this.serviceUrl) {
            this.serviceUrl = this.environment == Environment.Test ? ServiceEndpoints.PORTICO_TEST : ServiceEndpoints.PORTICO_PRODUCTION;
        }
