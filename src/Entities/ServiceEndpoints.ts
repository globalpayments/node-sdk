export enum ServiceEndpoints {
  ...
  GP_API_EU_PRODUCTION = "https://apis.eu.globalpay.com/ucp",
  GP_API_EU_TEST = "https://apis.sandbox.eu.globalpay.com/ucp",
  GP_API_EU_QA = "https://apis.qa.eu.globalpay.com/ucp",
