...
test.skip("002b - edit payment method from id", async (_t) => {
...
test.skip("003 - find", async (_t) => {
  await Customer.find(customerId);
});

test.skip("004a - charge stored card", async (t) => {
  t.plan(2);
...
test.skip("004b - verify stored card", async (t) => {
  t.plan(2);
...
test.skip("004c - refund stored card", async (t) => {
  t.plan(2);
...
test.skip("005 - delete payment method", async (_t) => {
  const paymentMethod = new RecurringPaymentMethod(
    customerId,
    paymentId("Credit"),
  );
...
test.skip("006 - recurring payment", async (t) => {
  t.plan(2);
