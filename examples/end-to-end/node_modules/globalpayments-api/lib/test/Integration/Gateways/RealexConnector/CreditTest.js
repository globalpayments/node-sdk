...
ava_1.default("credit auth mobile - apple pay", function (t) { return __awaiter(_this, void 0, void 0, function () {
    var encryptedCard, incorrectHashError, cannotDecryptError;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                t.plan(6);
                encryptedCard = new _1.CreditCardData();
                ...
                return [4 /*yield*/, t.throws(encryptedCard
                        .authorize(10)
                        .withCurrency("USD")
                        .withModifier(_1.TransactionModifier.EncryptedMobile)
                        .withAllowDuplicates(true)
...
ava_1.default("credit auth mobile - google pay", function (t) { return __awaiter(_this, void 0, void 0, function () {
...
ava_1.default("implied decimal conversion", function (t) { return __awaiter(_this, void 0, void 0, function () {
